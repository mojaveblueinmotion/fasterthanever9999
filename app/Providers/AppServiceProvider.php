...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        if ($this->app->environment('rusman')) {
    ...
    public function boot()
    {
        ...
        $this->newBaseMacro();
        Model::shouldBeStrict(env('APP_ENV') == 'rusman');
    }
    ...
    public function newBaseMacro()
    {
        ...
        Route::macro(
            'grid',
            function ($uri, $controller, $params = ['with' => ['submit', 'approval', 'print', 'history', 'tracking']]) {
